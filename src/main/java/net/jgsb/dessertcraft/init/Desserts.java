...
public class Desserts {
	...
	public static void init() {
		...
		mint_seeds = new ItemSeeds(mint_plant, Blocks.FARMLAND).setUnlocalizedName("mint_seeds");
	...
	public static void register() {
		...
		GameRegistry.register(mint_plant, new ResourceLocation(Reference.MOD_ID, mint_plant.getUnlocalizedName().substring(5)));
	}
	...
	public static void registerRender(Block block) {
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(Item.getItemFromBlock(block), 0, new ModelResourceLocation(Reference.MOD_ID + ":" + block.getRegistryName()));
	}
}
